class AppImages {
  ...
  static const String rate = "${assetsPath}rate.png";
  static const String setInfo = "${assetsPath}setInfo.png";
  static const String notif = "${assetsPath}notif.png";
  static const String trash = "${assetsPath}trash.png";
  static const String privacy = "${assetsPath}privacy.png";
  static const String connect = "${assetsPath}connect.png";
  static const String search = "${assetsPath}search.png";
  static const String loction = "${assetsPath}location.png";
  static const String status = "${assetsPath}status.png";
  static const String verified = "${assetsPath}verified.png";
  static const String review = "${assetsPath}review.png";
  static const String phone = "${assetsPath}Phone.png";
  static const String video = "${assetsPath}Video.png";
